...
public class BrowserUtils {
    ...
    */
    ...
    public static LocalDate getDateFromString(String date, DateTimeFormatter dateTimeFormatter){
    ...
    public static void waitUntilAlertIsPresent(int time){
        new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(time)).until(ExpectedConditions.alertIsPresent());
    }
